...
#pragma config(Motor,  port7,           Puncher1,      tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port10,          BallDispenser, tmotorVex393_HBridge, openLoop, reversed)
	...
	while (true)
	{
		...
		else if (btn8r == 1)
		{
			...
			else
			{
				...
				if (SensorValue[BallDispenserPosition] >= 1000)
				{
					// Open
					...
					clearTimer(T2);
					while(SensorValue[BallDispenserPosition] > 900 && time1[T2] < 5000)
					{
					}
				...
				{	// Close
					...
					clearTimer(T2);
					while(SensorValue[BallDispenserPosition] < 1100 && time1[T2] < 5000)
					{
					}
